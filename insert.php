	...
	<form action="insert.php" method="POST" enctype="multipart/form-data">
		<table bgcolor="orange" width="500" border="2" cellspacing="2" align="center">
			...
			<tr>
				...
				<input type="submit" name="submit" value="Add site now"></td>
			</tr>
			</table>
...
{
	$insert_query="insert into sites(site_title,site_link,site_keyword,site_desc,site_image) values('$site_title','$site_link','$site_keyword','$site_desc','$site_image')";
